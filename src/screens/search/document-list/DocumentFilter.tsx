...
const DocumentFilter = () => {
  ...
  const onSubmit = (values: Filters) => {
    Keyboard.dismiss();
    navigation.navigate(AppRouter.DOCUMENT_LIST, values);
  };
  ...
  return (
    <View style={styles.container} flex={1}>
      <Formik
        initialValues={{
          documentCode:
            cachedParams[AppRouter.DOCUMENT_LIST]?.documentCode || '',
          documentNumber:
            cachedParams[AppRouter.DOCUMENT_LIST]?.documentNumber || '',
          content: cachedParams[AppRouter.DOCUMENT_LIST]?.content || '',
          agencyIssued:
            cachedParams[AppRouter.DOCUMENT_LIST]?.agencyIssued || '',
        }}
